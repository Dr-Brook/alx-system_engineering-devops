Script ihat prints the script that lists all files absolute path name of current working directory
...
Write a script that lists all files including hidden files
